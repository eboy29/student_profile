 ...
 if(isset($_POST['submit'])){
        ...
        if(strlen($stud_num)<5){
            ...
            if(mysqli_num_rows($validate_stud_num) > 0){
                ...
                $insert = "INSERT INTO pending_request(Student_Number, First_Name, Middle_Name, Last_Name, Age, Date_of_Birth, 
                ...
                '$relation','$pnum','$job','$fpic','$time_stamp')";
                    ...
                    $_SESSION['reg_success'] = "Registered Successfully and Wait for Admin Approval";
