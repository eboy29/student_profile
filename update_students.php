...
<!-- <div class="alert alert-danger d-flex justify-content-center align-items-center" role="alert" id="alerter">
 success
  ...
  <h2 class="container-fluid d-flex justify-content-center mt-3 mb-4">Update Student</h2>



  <form class="row g-3" action="functions/f_update_students.php" id="add_student" method ="POST" onmousemove="findAge()">
      ...
      $sql = "SELECT * FROM student_table where Student_ID = '$update_id'";
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" value="<?php echo $row['Student_Number']?>" required ="required" id="stud_num1" name ="stud_num" onkeypress="number(event)">
      ...
      <div class="col-md-3">
        ...
        <input type="date" class="form-control" name ="dob" id ="dobCal" value="<?php echo  $row['Date_of_Birth'];?>">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" placeholder="+63" value="<?php echo $row['Contact_Number']?>" id="inputPassword4" name ="cnum" onkeypress="number(event)">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="inputPassword4" name ="email" value="<?php echo $row['Email']?>">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="inputPassword4" name ="pob" value="<?php echo $row['Place_of_Birth']?>">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="inputPassword4" value="<?php echo $row['Religion']?>" name ="religion">
        <p class="text-danger help-block"></p>
      </div>
    ...
    <div class="row m-0 mb-3">
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control" id="inputAddress" placeholder="1234 Main St" name ="homeno" value="<?php echo $row['HomeNo'];?>">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control" id="inputAddress" value="<?php echo $row['Street'];?>" placeholder="Example St/Building " name ="street">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control" id="inputAddress" value="<?php echo $row['Barangay'];?>" placeholder="Sito Juan/Roxas Ave" name ="brgy">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control" id="inputAddress" value="<?php echo $row['City'];?>" placeholder="Manila" name ="city">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-6">
        ...
        <input type="text" class="form-control" id="inputAddress" value="<?php echo $row['Province'];?>" placeholder="NCR" name ="prov">
        <p class="text-danger help-block"></p>
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="inputZip" value="<?php echo $row['Parents_Name']?>"name ="pname">
      </div>
      ...
      <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="inputZip" value="<?php echo $row['Relationship'];?>" name ="relation">
      </div>

      <!-- OCCUPATION -->
      <div class="col-md-3">
        <label for="inputZip" class="form-label">Occupation</label>
        <input type="text" class="form-control" id="inputZip" value="<?php echo $row['Occupation'];?>" name ="job">
      </div>

      <!-- CONTACT NUMBER -->
      <div class="col-md-3">
        <label for="inputZip" class="form-label">Contact Number</label>
        <input type="text" class="form-control" id="inputZip" name ="pnum" value="<?php echo $row['Number'];?>" onkeypress="number(event)">
      </div>
      ...
      <div class="row m-0 mb-3">
        <div class="col-15">
          <button type="submit" class="btn btn-primary" name ="submit" id ="sendbtn">Update Student</button>
        </div>
      </div>
